          ...
          <FadeIn>
            ...
            <div className="prose-warm mt-8">
              ...
              <ul>
                ...
                <li>Information about your solar contracting firm and operations needed to quote insurance (installation types, panel and equipment values, payroll, loss history)</li>
